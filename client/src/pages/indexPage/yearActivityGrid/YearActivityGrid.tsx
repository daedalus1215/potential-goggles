            ...
            {allActivities.map((activity: any) => (
                <Tooltip key={activity.date}
                    ...
                    <span className={classNames(styles.contentOutline, {
                        [styles.darkestGreen]: (activity.time / 1000 / 60 /60) > 4,
                        [styles.darkGreen]: (activity.time / 1000 / 60 /60) > 3 && (activity.time / 1000 / 60 /60) < 4,
                        [styles.medGreen]: (activity.time / 1000 / 60 /60) > 2 && (activity.time / 1000 / 60 /60) < 3,
                        [styles.red]: (activity.time / 1000 / 60 /60) > 1 && (activity.time / 1000 / 60 /60) < 3,
                    })}>
